...
void drawx (int nx, int ny, double r1, double r2, double offset, double angle);
void drawy (int nx, int ny, double r1, double r2, double offset, double angle);
